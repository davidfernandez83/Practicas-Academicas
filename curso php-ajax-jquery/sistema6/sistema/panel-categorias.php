	...
	<div id="main">
		...
		<table id="paneles">
			<tr>
				<th>ID</th>
				<th>Nombre</th>
				<th colspan="2"><a href="form-alta-categoria.php">
			...
			<tr>
				...
				<td class="editar">
					<a href="form-editar-categoria.php?cat_id=<?php echo $fila['cat_id'] ?>">
					<img src="imgs/editar3.png" title="Editar categoria"></a>
				</td>
				<td class="editar">
