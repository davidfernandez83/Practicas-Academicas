<?php
	...
	$sql="SELECT prd_nombre,prd_descripcion,prd_precio,prd_foto1 FROM productos WHERE prd_nombre LIKE '%".$criterio."%'";
...
<body>
	...
	<div id="main">
		...
		<?php
		if($cantidad==0){
			echo "No se han encontrado resultados para: ",$criterio;
		}
		else{ ?>
		<table id="panel">
			<tr>
