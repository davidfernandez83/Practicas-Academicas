	...
	<div id="main">
		...
		<table id="panel">
			<tr>
				...
				<th>Precio</th>
				<th>Imagen</th>
				<th colspan="2"><a href="form-agregar-producto.php">
					<img src="imgs/agregar2.png" title="Agregar producto"></a></th>
			</tr>
			...
			<tr>
				...
				<td class="editar">
					<a href="editar-producto.php?id=<?php echo $fila['prd_id'] ?>">
					<img src="imgs/editar3.png" title="Editar producto"></a></td>
				<td class="editar">
					<a href="confirmar-eliminar-producto.php?id=<?php echo $fila['prd_id'] ?>">
					<img src="imgs/eliminar.png" title="Eliminar producto"></td>
			</tr>
			<?php //fin de muestreo
			}
			?>
