	...
	<div id="main">
		...
		<table id="paneles">
			<tr>
				...
				<th>Nombre</th>
				<th>Email</th>
				<th colspan="2"><a href="form-alta-usuario.php">
			...
			<tr>
				...
				<td class="editar"><a href="form-editar-usuario.php?usu_id=<?php echo $fila['usu_id'] ?>">
					<img src="imgs/editar3.png" title="Editar usuario"></td>
