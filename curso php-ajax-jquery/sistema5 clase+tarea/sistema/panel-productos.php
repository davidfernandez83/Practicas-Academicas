		...
		<table id="panel">
			<tr>
				...
				<th colspan="2"><a href="form-agregar-producto.php" >
					<img src="imgs/agregar2.png" title="Agregar producto"></a>
				</th>
			</tr>
			...
			<tr>
				...
				<td class="editar">
					...
					<img src="imgs/editar3.png" title="Editar producto"></a>
				</td>
				<td class="editar">
					<a href="form-borrar-producto.php?prd_id=<?php echo $fila['prd_id']?>">
					<img src="imgs/eliminar.png" title="Eliminar producto"></a>
				</td>
			</tr>
			<?php //fin de muestreo
			}
