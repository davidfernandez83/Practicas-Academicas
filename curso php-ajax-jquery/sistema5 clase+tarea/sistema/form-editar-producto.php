		...
		<form action="editar-producto.php" method="POST" enctype="multipart/form-data"> 
			<table id ="paneles">
				...
				<tr>
					...
					<td class="editar">
						<img src="imagenes/<?php echo $fila2['prd_foto2'] ?>">
				...
				<tr>
					<td colspan="2" class="centrar">
						...
						<input type="hidden" name="prd_foto1_old" value="<?php echo $fila2['prd_foto1'] ?>">
						<input type="hidden" name="prd_foto2_old" value="<?php echo $fila2['prd_foto2'] ?>">
