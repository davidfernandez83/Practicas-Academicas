...
public class MainActivity extends Activity {
	...
	private Boolean botonNaranja=false;
	private Switch btnBoton6;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnBoton1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0)
			{
				...
				if(botonNaranja==false)
				{
					btnBoton1.setBackgroundColor(Color.parseColor("#fe642e"));
					botonNaranja = true;
				}
				else
				{
					btnBoton1.setBackgroundColor(Color.parseColor("#848484"));
					botonNaranja = false;
				}
			}
        }
        ...
        btnBoton6 = (Switch) findViewById(R.id.switch1);
        btnBoton6.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if(btnBoton6.isChecked())
				{
					lblMensaje.setText("Switch activado");
					lblMensaje.setTextColor(Color.parseColor("#fe642e"));
				}
				else
				{
					lblMensaje.setText("Switch desactivado");
					lblMensaje.setTextColor(Color.parseColor("#000000"));
				}
