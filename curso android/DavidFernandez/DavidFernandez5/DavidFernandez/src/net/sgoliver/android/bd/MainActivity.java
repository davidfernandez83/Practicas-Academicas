...
public class MainActivity extends Activity {
		...
		if (c.moveToFirst()) {
		     ...
		     do {
		    	 int i=0;
		          ...
		          con[i]=new Contacto(cod,nom,edad);
		          i++;
	...
	class Adaptador extends ArrayAdapter<Contacto> {
		...
		Adaptador(Activity context) {
			super(context, R.layout.listitem_contacto, con);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			lblCodigo.setText(con[position].getCodigo());
			
			TextView lblNombre = (TextView)item.findViewById(R.id.LblNombre);
			lblNombre.setText(con[position].getNombre());
