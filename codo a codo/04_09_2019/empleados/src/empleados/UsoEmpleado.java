...
public class UsoEmpleado {
      ...
      */
      ...
      Empleado jefeComercial = new Jefe("Salvador Ramirez",40000,2005,14,01);
      Comparable ejemploEmpleado = new Empleado("Daniela Rivas",27000,2010,12,30);
      if(jefeComercial instanceof Jefe){
          System.out.println("Es del tipo Jefe");
      }
      ...
      System.out.println(jefeRRHH.tomaDesiciones("despedir al 5% del personal de sistemas"));
      
         System.out.println("El jefe de sistemas " + jefeSistemas.unNombre() + "tiene un bonus de: "
                            + jefeSistemas.recibeBonus(3000));
         //System.out.println(misEmpleados[2}.u]);
